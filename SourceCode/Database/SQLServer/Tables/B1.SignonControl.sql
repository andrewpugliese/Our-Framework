...
(
	ControlCode					TINYINT NOT NULL DEFAULT(1) CONSTRAINT CC_SignonControl_Code CHECK (ControlCode = 1),
	...
	RestrictSignonMsg			VARCHAR(256), -- Message to display when preventing new signon
	SignoffWarningMsg			VARCHAR(256), -- Message to display before signing users off
	LastModifiedUserCode		INT,
	LastModifiedDateTime		DATETIME,
	CONSTRAINT PK_SignonControl PRIMARY KEY (ControlCode) 
) ON B1Core

GO

ALTER TABLE B1.SignonControl
ADD CONSTRAINT FK_SignonControl_UserMaster
