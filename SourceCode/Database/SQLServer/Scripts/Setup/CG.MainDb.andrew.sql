...
if exists (select null from sys.databases where name = @dbName)
	begin
		...
		CLOSE cUsers
		DEALLOCATE cUsers
		drop database ContentGalaxy

	end

go
-- ContentGalaxy database 
-- primary filegroup
...
create database ContentGalaxy on  primary 
( name = N'ContentGalaxy'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\ContentGalaxy.mdf' 
, SIZE = 3048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )

-- The filegroup for the B1 Core Indexes
, filegroup ContentGalaxyIdx 
( name = N'ContentGalaxyIdx'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\ContentGalaxy_Idx.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
, filegroup B1Core
( name = N'B1Core'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\ContentGalaxy_B1Core.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
, filegroup B1CoreIdx 
( name = N'B1CoreIdx'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\ContentGalaxy_B1CoreIdx.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
-- define a Log file
 LOG on 
( name = N'ContentGalaxy_log'
, filename = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLSERVER2008\MSSQL\DATA\ContentGalaxy_log.ldf' 
, SIZE = 1024KB 
, MAXSIZE = 2048GB 
, FILEGROWTH = 10%)
go
...
if not exists (select * from sys.server_principals where name = N'owner')
	...
	, default_database = ContentGalaxy
