...
( name = N'B1Sample'
, filename = N'D:\DB\MSSQL\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\B1Sample.mdf' 
, SIZE = 3048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
, filegroup B1Core
( name = N'B1Core'
, filename = N'D:\DB\MSSQL\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\B1Sample_B1Core.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
, filegroup B1CoreIdx 
( name = N'B1CoreIdx'
, filename = N'D:\DB\MSSQL\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\B1Sample_B1CoreIdx.ndf' 
, SIZE = 2048KB 
, MAXSIZE = UNLIMITED
, FILEGROWTH = 1024KB )
...
-- define a Log file
 LOG on 
( name = N'B1Sample_log'
, filename = N'D:\DB\MSSQL\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\B1Sample_log.ldf' 
, SIZE = 1024KB 
, MAXSIZE = 2048GB 
, FILEGROWTH = 10%)
go
