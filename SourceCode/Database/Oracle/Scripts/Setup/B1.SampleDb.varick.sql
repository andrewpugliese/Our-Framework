...
/
create tablespace B1Core datafile 'C:\APP\ADMINISTRATOR\ORADATA\B1SAMPLE\B1Core.DBF'
SIZE 20M AUTOEXTEND ON
/
create tablespace B1CoreIdx
datafile 'C:\APP\ADMINISTRATOR\ORADATA\B1SAMPLE\B1CoreIdx.DBF'
SIZE 20M AUTOEXTEND ON
/
